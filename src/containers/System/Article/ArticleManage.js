...
const ArticleManage = (props) => {
    ...
    return (
        <div className="articleManage">
            ...
            <TabArticle activeTab={activeTab} setActiveTab={setActiveTab} />

            <TabContent activeTab={activeTab}>
                <TabPane tabId="1">
                    <DescProduct categoryId={categoryId} setProductId={setProductId} DetailCategory={DetailCategory} category={category} changeCategory={changeCategory} productId={productId} />
                ...
                <TabPane tabId="2">
                    <div className="h5 text-dark">
                        Danh sách(<small>{articles?.length > 0 ? articles.length : 0}</small>)
                    </div>
