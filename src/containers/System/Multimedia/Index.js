...
const Multimedia = (props) => {
    ...
    return (
        <div className="multimedia">
            ...
            <TabMultimedia activeTab={activeTab} setActiveTab={setActiveTab} />
                        ...
                        <div className="formSlide col-md-12">
                            ...
                            <div className="upload-file d-flex col-md-4">
                                <div className="form-group col-5 p-0">
                                    ...
                                    <label htmlFor="previewImg" className="btn btn-warning w-100">
                                        <i className="fas fa-upload"></i> Tải ảnh
                                    </label>
                                </div>

                                <div
                                    className="preview-image col-7 border"
