...
function SpecialCategory(props) {
    const { category, categoryId, setCategoryId, action, saveCategory, categoryName, setCategoryName, changeImageCategory, categoryPreviewImg, specialCategories, editSpecialCategory } = props;

    return (
        <TabPane tabId="2">
            <form className="list-category-special" onSubmit={saveCategory} encType="multipart/form-data">
                <div className="formCategory">
                    ...
                    <div className="upload-file d-flex col-md-4">
                        <div className="form-group col-4 p-0">
                            <label>Ảnh</label>
                            <input id="previewImgCategory" type="file" hidden onChange={(e) => changeImageCategory(e)} />

                            <label htmlFor="previewImgCategory" className="btn btn-warning w-100">
                                <i className="fas fa-upload"></i> Tải ảnh
                            </label>
                        </div>

                        <div
                            className="preview-image col-md-8 border"
                        ...
                        >
                            {categoryPreviewImg ? (
                                ...
                                <img src="https://dci.edu.vn/wp-content/themes/consultix/images/no-image-found-360x250.png" className="w-50" alt="..." />
                            )}
                        </div>
                    </div>
                ...
                <div className="text-dark">
                    Danh sách (<b>{specialCategories.length}</b>)
                </div>
