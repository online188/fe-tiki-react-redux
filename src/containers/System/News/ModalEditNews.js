                    ...
                    <div>
                        ...
                        <div className="row">
                            <div className="form-group col-4">
                                ...
                                <button onClick={() => setDate(new Date())} type="button" className="btn btn-primary">
                                    <i className="fas fa-sync-alt"></i>
                                </button>
                            </div>
                            <div className="form-group col-md-4">
                                <label>Danh mục</label>
                                <select className="form-control" onChange={(e) => setCategory(e.target.value)} value={category_id}>
