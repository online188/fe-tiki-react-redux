...
function Profile(props) {
    ...
    return (
        <>
            ...
            <hr />
            <form className="d-flex" onSubmit={updateUser} encType="multipart/form-data">
                <div className="col-8 pl-0">
                    ...
                    <div className="form-group d-flex">
                        ...
                        <div className="form-group dateBirth col-9">
                            <select className="form-control" value={date} onChange={(e) => setDateBirth(e.target.value)}>
                                {[...Array(31)].map((item, index) => {
                                    return <option key={index}>{index + 1}</option>;
                                })}
                            </select>

                            <select className="form-control" value={month} onChange={(e) => setMonthBirth(e.target.value)}>
                ...
                <div className="col-4 py-4 bg-light text-center border-left">
                    <div>
                        <img
                            src={previewImg ? previewImg : `https://dci.edu.vn/wp-content/themes/consultix/images/no-image-found-360x250.png`}
                    ...
                    <div className="d-flex justify-content-center mt-3">
                        <div className="form-group">
                            ...
                            <label htmlFor="previewImg" className="btn btn-success px-3">
                                <i className="fas fa-upload"></i> Đổi ảnh
                            </label>
                        </div>
                    </div>
