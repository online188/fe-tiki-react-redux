...
const Footer = () => {
    ...
    return (
        <>
            <div className="footer"> @CopyRight HoangNam </div>
            {categoryMB && (
                <div className="category-mobile">
                    ...
                    <div className="category-content">
                        ...
                        <div className="catg-right">
                            <div className="catg-right-header">abcd</div>
                                    ...
                                    Products.map((item, index) => {
                                        return (
                                            ...
                                            <div onClick={() => viewDetail(item)}>
                                                <img src={item.image} className="w-75" alt="" />
                                                <h6 className="my-2 text-dark">aaaaa{item.name}</h6>
                                            </div>
                                        );
                                    })
                                ) : (
