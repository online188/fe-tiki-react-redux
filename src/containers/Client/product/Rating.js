            ...
            <div className="star-overview">
                <div className="star col-md-3">
                    <div className="numbStar">
                        <span className="starAVG">{ratingProduct && averageStarRating(ratingProduct)}</span>

                        <div>
                            <ReactStars count={5} value={ratingProduct && parseInt(averageStarRating(ratingProduct))} edit={false} size={24} color2={'#ffd700'} />
                ...
                <div className="filter-vote col-md-9">
                    ...
                    <div>
                        5<span className="fa fa-star"></span>
                    </div>
                    <div>
                        4<span className="fa fa-star"></span>
                    </div>
                    <div>
                        3<span className="fa fa-star"></span>
                    </div>
                    <div>
                        2<span className="fa fa-star"></span>
                    </div>
                    <div>
                        1<span className="fa fa-star"></span>
                    </div>
                </div>
            </div>
                            ...
                            <div className="list-vote" key={index}>
                                ...
                                <div className="list-vote-customer col-md-9">
                                    <div className="title d-flex">
                                        {item.rating && (
                                            <div className="star">
                                                <ReactStars count={5} value={item.rating} edit={false} size={18} color2={'#ffd700'} />
